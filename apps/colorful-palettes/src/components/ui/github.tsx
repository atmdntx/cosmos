...
const GithubIcon = forwardRef<GithubIconHandle, GithubIconProps>(
  ({ onMouseEnter, onMouseLeave, className, size = 28, animate, play, ...props }, ref) => {
    ...
    }, [isPropControlled, shouldAnimate, bodyControls, tailControls]);
    ...
    const handleMouseEnter = useCallback(
      ...
      [bodyControls, onMouseEnter, tailControls, isPropControlled],
    );
    ...
    const handleMouseLeave = useCallback(
      ...
      [bodyControls, tailControls, onMouseLeave, isPropControlled],
    );
