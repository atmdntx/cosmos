import {
  TailwindColorNames,
  type TailwindColors,
  type TailwindErrorColors,
  type TailwindNeutralColors,
} from "./types";
...
export const NEUTRAL_TAILWIND_COLORS: TailwindNeutralColors = pickColors(TAILWIND_COLORS, [
...
export const ERROR_TAILWIND_COLORS: TailwindErrorColors = pickColors(TAILWIND_COLORS, [
  TailwindColorNames.Rose,
  TailwindColorNames.Red,
]);
